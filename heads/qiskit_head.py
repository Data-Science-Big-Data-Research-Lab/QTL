...
class QiskitHead(nn.Module):
    ...
    def __init__(
        ...
        self.gradient_method = "param_shift" if ((noise or self.backend == "aer") and gradient_method == "reverse") else gradient_method
    ...
    def _create_qnn(self):
        ...
        if self.backend == "statevector":
            ...
            noise_model = self._build_noise_model() if self.noise else None
            # AerEstimatorV2 (CPU by default).
            ...
            if noise_model is not None:
                ...
                if self.shots is None:
                    aer_options["approximation"] = True
